            ...
            <q-card-section>
                ...
                <template v-else-if="pdfSrc">
                    ...
                    <q-scroll-area style="height: 80vh">
                        ...
                        <q-no-ssr>
                            <PdfViewBase :src="pdfSrc" v-model:scale="scale" v-model:page="page" v-model:pagess="pages">
                            </PdfViewBase>
                        </q-no-ssr>
                    </q-scroll-area>
...
import { downloadFileFromUrl, downloadFromBlob, getBlobFromAxiosResponse, getFileNameFromAxiosResponse } from '@/utils/fileUtils';
