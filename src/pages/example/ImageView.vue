<template>
    <q-page padding>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                ...
                                <div class="row">
                                    <div class='col-4 col-md-3 q-pa-xs' v-for="(item, i) in imageItems"
                                        ...
                                        <files-preview-item style="border-radius: 10px" :item="item" :index="i"
                            ...
                            <div class="col-12 col-md-6 q-px-md">
                                ...
                                <base-scroll-area height="310px">
                                    <files-preview-item-alt v-for="(itemAlt, iAlt) in imageItems"
                    ...
                    <q-card-section>
                        ...
                        <div class="row">
                            <div class='col-4 col-md-2 q-pa-xs' v-for="(pdf, pdfIndex) in pdfItems"
                                ...
                                <files-preview-item style="border-radius: 10px" :item="pdf" :index="pdfIndex"
                    ...
                    <q-card-section>
                        ...
                        <div class="row">
                            <div class='col-4 col-md-2 q-pa-xs' v-for="(m, mIndex) in mixItems"
                                ...
                                <files-preview-item style="border-radius: 10px" :item="m" :index="mIndex"
        ...
        <photo-view v-if="showImageView" :show-dialog="showImageView" :files="imageItems"
            :selected-index="imageSelectIndex" :show-delete-image="false" :maximized="false" show-arrow
            @on-close="() => showImageView = false">
        </photo-view>

        <pdf-view v-if="showPdfView && pdfSrc" :src="pdfSrc" v-model:show="showPdfView" :title="pdfName"
            @on-close="() => onClosePefView"></pdf-view>


        <file-view v-if="showMixFiles && fileMixForView" :item="fileMixForView" :image-list="fileImageItemsForView"
            :select-index="fileMixImageSelectIndex" title="Images" :show-arrow="true" v-model:show="showMixFiles" />
    </q-page>
</template>
